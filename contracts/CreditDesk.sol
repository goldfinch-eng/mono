...
contract CreditDesk is Initializable, OwnableUpgradeSafe, OwnerPausable {
    ...
    function createCreditLine(
        ...
        require(
            underwriterCanCreateThisCreditLine(_limit, underwriter),
            "The underwriter cannot create this credit line"
        );
    ...
    function getUnderwriterCreditLines(address underwriterAddress)
        public
        view
        whenNotPaused
