...
import {
  ...
  MAINNET_STAKING_REWARDS_ADDRESS,
...
import {
  ...
  LOCALHOST_USDC_ADDRESS,
  LOCALHOST_STAKING_REWARDS_ADDRESS,
...
export let USDC_CONTRACT_ADDRESS = MAINNET_USDC_ADDRESS
export let STAKING_REWARDS_ADDRESS = MAINNET_STAKING_REWARDS_ADDRESS
...
if (dataSource.network() == "localhost") {
  ...
  USDC_CONTRACT_ADDRESS = LOCALHOST_USDC_ADDRESS
  STAKING_REWARDS_ADDRESS = LOCALHOST_STAKING_REWARDS_ADDRESS
}
