...
export class MigrateToSeniorPoolCall extends ethereum.Call {
  get inputs(): MigrateToSeniorPoolCall__Inputs {
    return new MigrateToSeniorPoolCall__Inputs(this);
  }

  get outputs(): MigrateToSeniorPoolCall__Outputs {
    return new MigrateToSeniorPoolCall__Outputs(this);
  }
}

export class MigrateToSeniorPoolCall__Inputs {
  _call: MigrateToSeniorPoolCall;

  constructor(call: MigrateToSeniorPoolCall) {
    this._call = call;
  }
}

export class MigrateToSeniorPoolCall__Outputs {
  _call: MigrateToSeniorPoolCall;
