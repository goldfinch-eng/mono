 ...
 * @returns Promise that resolves after the transaction has finished processing, including waiting for the subgraph to ingest that transaction. The return value is the submitted transaction, which has the transaction hash available on it.
 */
