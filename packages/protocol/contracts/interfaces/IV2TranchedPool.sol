...
import {IV3CreditLine} from "./IV3CreditLine.sol";

interface IV2TranchedPool {
  /// @notice Pool's credit line, responsible for managing the loan's accounting variables
  function creditLine() external view returns (IV3CreditLine);
  ...
  /// @param _principalGracePeriodInDays number of days after loan maturity before writedown kicks in
