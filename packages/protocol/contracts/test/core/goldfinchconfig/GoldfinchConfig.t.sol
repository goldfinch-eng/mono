...
contract GoldfinchConfigTest is GoldfinchConfigBaseTest {
  ...
  function testTheOrderOfTheEnumShouldNotChange() public {
    ...
    assertEq(
      gfConfig.getAddress(uint256(ConfigOptions.Addresses.MonthlyPeriodMapper)),
  ...
  function setUpTheEnums() private impersonating(GF_OWNER) {
    ...
    gfConfig.setAddress(uint256(ConfigOptions.Addresses.MonthlyPeriodMapper), address(11));
