...
export type ChainName = typeof LOCAL | typeof ROPSTEN | typeof MAINNET

const MAX_UINT = new BN("1157920892373161954235709850086879078i3269984665640564039457584007913129639935")
...
export type ChainId = LocalChainId | RopstenChainId | MainnetChainId

const CHAIN_IDS = genExhaustiveTuple<ChainId>()(LOCAL_CHAIN_ID, ROPSTEN_CHAIN_ID, MAINNET_CHAIN_ID)
