...
export const BACKER_FLIGHT_ACADEMY_GRANT_REASON = "backer_flight_academy"
export type BACKER_FLIGHT_ACADEMY_GRANT_REASON = typeof BACKER_FLIGHT_ACADEMY_GRANT_REASON
export const BACKER_GOLDFINCH_INVESTMENT_GRANT_REASON = "backer_goldfinch_investment"
export type BACKER_GOLDFINCH_INVESTMENT_GRANT_REASON = typeof BACKER_GOLDFINCH_INVESTMENT_GRANT_REASON
export const BACKER_LIQUIDITY_PROVIDER_GRANT_REASON = "backer_liquidity_provider"
export type BACKER_LIQUIDITY_PROVIDER_GRANT_REASON = typeof BACKER_LIQUIDITY_PROVIDER_GRANT_REASON
...
export type GrantReason =
  ...
  | BACKER_FLIGHT_ACADEMY_GRANT_REASON
  | BACKER_GOLDFINCH_INVESTMENT_GRANT_REASON
  | BACKER_LIQUIDITY_PROVIDER_GRANT_REASON
export const isGrantReason = (obj: unknown): obj is GrantReason =>
  ...
  obj === BACKER_FLIGHT_ACADEMY_GRANT_REASON ||
  obj === BACKER_GOLDFINCH_INVESTMENT_GRANT_REASON ||
  obj === BACKER_LIQUIDITY_PROVIDER_GRANT_REASON
