...
export const BACKER_FLIGHT_ACADEMY_DIRECT_GRANT_REASON = "backer_flight_academy"
export type BACKER_FLIGHT_ACADEMY_DIRECT_GRANT_REASON = typeof BACKER_FLIGHT_ACADEMY_DIRECT_GRANT_REASON
export const BACKER_LIQUIDITY_PROVIDER_DIRECT_GRANT_REASON = "backer_liquidity_provider"
export type BACKER_LIQUIDITY_PROVIDER_DIRECT_GRANT_REASON = typeof BACKER_LIQUIDITY_PROVIDER_DIRECT_GRANT_REASON
...
export type DirectGrantReason =
  ...
  | BACKER_FLIGHT_ACADEMY_DIRECT_GRANT_REASON
  | BACKER_LIQUIDITY_PROVIDER_DIRECT_GRANT_REASON
export const isDirectGrantReason = (obj: unknown): obj is DirectGrantReason =>
  ...
  obj === BACKER_FLIGHT_ACADEMY_DIRECT_GRANT_REASON ||
  obj === BACKER_LIQUIDITY_PROVIDER_DIRECT_GRANT_REASON
